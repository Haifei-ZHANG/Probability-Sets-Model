...
if __name__ == "__main__":
    evaluation_criteria = ['RF Acc', 'Determinacy', 'Single Acc', 'Set Acc', 'Set Size', 'U65', 'U80', 'RF Abstention Acc']
        ...
        for train_index, test_index in tqdm(kf.split(X)):
            ...
            for i in range(len(dist_types)):
                ...
                for j in range(len(prediction_types)):
                    ...
                    data_evaluations[k,:,index] = np.array(list(clf.evaluate(X_test, y_test, prediction_type).values()))
